...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("98aff9d605bf123247f98b1e3a02567eb5799d208d78ec30fb89737b1c1f79c5"));
...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("0482fae82061c1400ca141ccb3831ee91bbb054495b75bd13a44c83e6bdff949eb69c76cce3d8957328cec83513f3a1f40d15b4f8a0dcbdd14555bdd3fe45649b4");
        nDefaultPort = 51472;
        ...
        vSeeds.push_back(CDNSSeedData("resteemexposure.com", "bago.resteemexposure.com"));         // Single node address
        vSeeds.push_back(CDNSSeedData("myfxstore.com", "bilal.myfxstore.com")); // Single node address
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1522822929;
        genesis.nNonce = 186618;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0xfa211189d78247c5173828cdf035a808a69d74294022d0d5d170d707544d7ba8"));

        vFixedSeeds.clear();
        vSeeds.clear();


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 11); // Testnet pivx addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 106);  // Testnet pivx script addresses start with '8' or '9'
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1522823194;
        genesis.nBits = 0x1e0a1f44;
        genesis.nNonce = 5551720;

        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 51476;
        assert(hashGenesisBlock == uint256("0x3ba0bdc07f1acbd0453d2976a5faa10c10e7b14c93b83fad0d99b3b8c8c7d731"));
